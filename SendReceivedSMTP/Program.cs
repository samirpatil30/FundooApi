   ...
   public class Program
    {
        static void Main(string[] args)
        {
         ...
         //   Console.WriteLine(message.Body.ToString());
            ...
            try
            {
                string FromMail = "samir.patil30@gmail.com";
                ...
                using (SmtpClient SmtpServer = new SmtpClient("smtp.gmail.com"))
                {
                    ...
                    mail.To.Add("samir.patil30@gmail.com");
                    ...
                    SmtpServer.Credentials = new System.Net.NetworkCredential("samir.patil30@gmail.com", "samir@5648");
